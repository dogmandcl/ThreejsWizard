...
export class TerminalUI {
  ...
  startThinking(message = 'Thinking', turn?: number): void {
  ...
  async promptWithMode(defaultMode: ExecutionMode = 'single-shot'): Promise<{ text: string; mode: ExecutionMode }> {
    let currentMode: ExecutionMode = defaultMode;

    // Print mode indicator and instructions
    const printModeBar = (): void => {
