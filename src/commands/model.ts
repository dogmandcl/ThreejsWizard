...
import { ModelId, MODEL_MAP, DEFAULT_MODEL } from '../core/types.js';
...
export async function modelCommand(name?: string): Promise<void> {
  console.log();
  ...
  // Set model
  const modelName = name.toLowerCase() as ModelId;
